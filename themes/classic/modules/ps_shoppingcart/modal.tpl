  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-sm-center" id="myModalLabel">{l s='Add Product' d='Shop.Theme.Checkout'}</h4>
      </div>
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <div class="cart-content-btn">
                ...
                <a href="{$cart_url}" class="btn btn-primary">{l s='Save product' d='Shop.Theme.Actions'}</a>
              </div>
            </div>
          </div>
        </div>
